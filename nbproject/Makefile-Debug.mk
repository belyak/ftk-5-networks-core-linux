...
${OBJECTDIR}/src/spi/create_message.o: src/spi/create_message.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/create_message.o src/spi/create_message.cpp

${OBJECTDIR}/src/spi/SocketSPI.o: src/spi/SocketSPI.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/spi
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/SocketSPI.o src/spi/SocketSPI.cpp

${OBJECTDIR}/src/spi/SPI.o: src/spi/SPI.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/spi
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/SPI.o src/spi/SPI.cpp
...
${OBJECTDIR}/src/spi/ConsoleSPI.o: src/spi/ConsoleSPI.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/spi
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/ConsoleSPI.o src/spi/ConsoleSPI.cpp

${OBJECTDIR}/src/encoder/Encoder.o: src/encoder/Encoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/encoder
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/encoder/Encoder.o src/encoder/Encoder.cpp

${OBJECTDIR}/src/spi/commands/CommandResponse.o: src/spi/commands/CommandResponse.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/spi/commands
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/commands/CommandResponse.o src/spi/commands/CommandResponse.cpp

${OBJECTDIR}/src/converters/PlainConverter.o: src/converters/PlainConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/converters
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/converters/PlainConverter.o src/converters/PlainConverter.cpp

${OBJECTDIR}/src/spi/commands/SPICommand.o: src/spi/commands/SPICommand.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/spi/commands
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/spi/commands/SPICommand.o src/spi/commands/SPICommand.cpp

${OBJECTDIR}/src/net/socketaddr_to_str.o: src/net/socketaddr_to_str.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/net/socketaddr_to_str.o src/net/socketaddr_to_str.cpp

${OBJECTDIR}/src/net/create_server_socket.o: src/net/create_server_socket.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/net
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/net/create_server_socket.o src/net/create_server_socket.cpp

${OBJECTDIR}/src/engine/PersistentStatistics.o: src/engine/PersistentStatistics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/engine
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/engine/PersistentStatistics.o src/engine/PersistentStatistics.cpp

${OBJECTDIR}/src/engine/Statistics.o: src/engine/Statistics.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/engine
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/engine/Statistics.o src/engine/Statistics.cpp
